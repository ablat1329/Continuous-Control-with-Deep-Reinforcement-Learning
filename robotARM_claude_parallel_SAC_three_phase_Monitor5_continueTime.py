...
# # Load latest model and run full evaluation
# python script.py --eval-only

# # Load specific model
# python script.py --eval-only --model models_continueTime/best_model.zip

# # Load latest model, run 3 deterministic debug episodes
# python script.py --debug-rollout

# # Load specific model
# python script.py --debug-rollout --model models_continueTime/sac_her_checkpoint_800000_steps.zip

# # Run stochastic (exploration) rollouts
# python script.py --debug-rollout --stochastic

# # Run more episodes
# python script.py --debug-rollout --episodes 5

# # Combine options
# python script.py --debug-rollout --model best_model.zip --stochastic --episodes 10

# When you load a model checkpoint in Stable-Baselines3 and then call learn() again,
# the model still carries the same internal tensorboard_log path it was initialized with
# before saving. So unless you explicitly pass a new tb_log_name or re-instantiate the
# model with a new tensorboard_log argument, it keeps logging to the same subfolder (e.g. ./tensorboard_logs/SAC_phase_0_0).
